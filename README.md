...
dependencies {
    ...
    // [optional] revup network adapter library
    // bidding, waterfall adapter
    implementation "com.tnkfactory.revup:adapter.admob:25.2.0.0"
    
    // bidding adapter
    implementation "com.tnkfactory.revup:adapter.max:13.6.2.0"

    // waterfall adapter
    implementation "com.tnkfactory.revup:adapter.chartboost:9.11.0.0"
    implementation "com.tnkfactory.revup:adapter.pangle:7.9.1.3.0"
